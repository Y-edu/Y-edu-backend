...
(
    ...
    teaching_style1      enum ('CARING', 'CONFIDENCE_BOOSTER', 'FOCUSED', 'FUN', 'METICULOUS', 'PASSIONATE') not null,
    teaching_style2      enum ('CARING', 'CONFIDENCE_BOOSTER', 'FOCUSED', 'FUN', 'METICULOUS', 'PASSIONATE') not null
    );
...
(
    ...
    primary key,
    teacher_teacher_id bigint                                                                                                                                                                                                                              null,
    district           enum ('강남구', '강동구', '강북구', '강서구', '경기지역', '고양', '관악구', '광진구', '구로구', '금천구', '노원구', '도봉구', '동대문구', '동작구', '마포구', '분당', '서대문구', '서초구', '성동구', '성북구', '송파구', '안양', '양천구', '영등포구', '온라인', '용산구', '용인', '은평구', '인천', '종로구', '중구', '중랑구') not null,
