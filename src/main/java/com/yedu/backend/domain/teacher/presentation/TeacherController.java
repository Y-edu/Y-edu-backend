...
public class TeacherController {
    ...
    @PostMapping("/form")
    @Operation(summary = "선생님 기본정보 신청건 API")
    ...
    @Operation(summary = "선생님 프로필 사진 및 영상 API")
    ...
    @Operation(summary = "선생님 프로필 사진 및 닉네임 조회 API")
    ...
    @Operation(summary = "수학 선생님 정보 조회 API")
    ...
    @Operation(summary = "영어 선생님 정보 조회 API")
    ...
    @Operation(summary = "수학 수업 정보 조회 API")
    ...
    @Operation(summary = "영어 수업 정보 조회 API")
    ...
    @Operation(summary = "선생님 가능 지역 및 시간 조회 API")
