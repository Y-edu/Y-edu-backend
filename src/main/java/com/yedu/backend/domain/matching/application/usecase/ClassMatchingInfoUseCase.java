...
public class ClassMatchingInfoUseCase {
    ...
    public ApplicationFormToTeacherResponse applicationFormToTeacher(String applicationFormId, long teacherId) {
        ...
        classMatchingGetService.classMatchingByApplicationFormIdAndTeacherId(applicationFormId, teacherId);
