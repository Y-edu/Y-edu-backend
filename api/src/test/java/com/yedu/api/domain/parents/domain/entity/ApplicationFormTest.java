  ...
  class Describe_maxRoundNumber {
    ...
    void it_returns_6_when_applicationFormId_is_T16() {
      ...
      ApplicationForm form =
          ApplicationForm.builder().applicationFormId("T-16").classCount("주 3회").build();
    ...
    @CsvSource({"주 4회, 16", "주 3회, 12", "5회, 20", "7, 28"})
    ...
    void it_calculates_based_on_classCount(String classCount, int expected) {
      // given
      ApplicationForm form =
          ApplicationForm.builder().applicationFormId("강남구12").classCount(classCount).build();
    ...
    void it_returns_null_when_no_number_found() {
      // given
      ApplicationForm form =
          ApplicationForm.builder().applicationFormId("강남구12").classCount("없음").build();
