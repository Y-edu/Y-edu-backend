...
public class TeacherMapper {
    ...
    public static List<TeacherAvailable> mapToTeacherAvailable(Teacher teacher, List<DayTime> dayTimes) {
        return dayTimes.stream().flatMap(dayTime-> dayTime.getTimes()
            .stream().map(time-> TeacherAvailable.builder()
                .teacher(teacher)
                .day(dayTime.getDay())
                .availableTime(time)
                .build()))
