package com.yedu.api.global.event.publisher;
...
public class EventPublisher {
  ...
  public void publishMatchingConfirmEvent(
      ParentsClassInfoEvent parentsClassInfoEvent, MatchingConfirmTeacherEvent teacherEvent) {
