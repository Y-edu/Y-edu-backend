...
import com.yedu.api.domain.teacher.domain.entity.constant.TeacherGrade;
...
public class Teacher extends BaseEntity {
  ...
  @Embedded private TeacherInfo teacherInfo;

  @Embedded private TeacherSchoolInfo teacherSchoolInfo;

  @Embedded private TeacherClassInfo teacherClassInfo;
  ...
  public boolean isActive() {
    if (this.status == TeacherStatus.활동중 || this.status == TeacherStatus.일시정지) return true;
    return false;
  }
