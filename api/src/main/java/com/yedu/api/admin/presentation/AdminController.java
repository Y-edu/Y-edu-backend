...
import com.yedu.api.admin.application.dto.req.LoginRequest;
...
import com.yedu.api.admin.application.dto.res.AllAlarmTalkResponse;
import com.yedu.api.admin.application.dto.res.AllApplicationResponse;
import com.yedu.api.admin.application.dto.res.AllFilteringTeacher;
...
import com.yedu.api.admin.application.usecase.AdminAuthUseCase;
import com.yedu.api.admin.application.usecase.AdminInfoUseCase;
import com.yedu.api.admin.application.usecase.AdminManageUseCase;
import com.yedu.api.admin.domain.entity.Admin;
import com.yedu.api.domain.teacher.domain.entity.constant.TeacherGender;
import com.yedu.api.global.config.security.jwt.dto.JwtResponse;
...
public class AdminController {
  ...
  @Operation(
      summary = "매칭 관리 - 처리상태 반대로 변경",
      description = "해당 신청서의 현상태 변경 API - 완료는 미완료로, 미완료는 완료로")
  ...
  public ResponseEntity updateParentsName(
      @PathVariable long parentsId, @RequestBody ParentsKakaoNameRequest request) {
  ...
  public ResponseEntity updateTeacherIssue(
      @PathVariable long teacherId, @RequestBody TeacherIssueRequest request) {
  ...
  public ResponseEntity updateTeacherIssue(
      @PathVariable long teacherId, @RequestBody TeacherVideoRequest request) {
  ...
  @Operation(
      summary = "신청서 상세조회 - 매칭 학부모 정보",
      description = "학부모 정보 (신청건ID, 카카오 이름, 전화번호 등등) 조회 API")
  public ResponseEntity<CommonParentsResponse> commonParents(
  ...
  public ResponseEntity<AllFilteringTeacher> searchTeachers(
    ...
    TeacherSearchRequest request =
        new TeacherSearchRequest(districts, subjects, universities, genders, search);
    AllFilteringTeacher allFilteringTeacher =
        adminInfoUseCase.searchAllTeacher(applicationFormId, request);
  ...
  public ResponseEntity<JwtResponse> regenerate(
