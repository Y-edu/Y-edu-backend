...
public enum BizpurrioTemplate {
  ...
  YEDU_OFFICIAL_PAY_NOTIFICATION_V2(
      "bizp_2025081800173832533423054", "학부모 결제선생 요금 청구 v1", Profile.YEDU_OFFICIAL),
  YEDU_OFFICIAL_PARENT_COMPLETE_TALK_NOTIFY(
      "bizp_2025081800160232533510346", "학부모 과외 리뷰 v1", Profile.YEDU_OFFICIAL),
  YEDU_OFFICIAL_PARENT_COMPLETE_TALK_NOTIFY_V2(
      "bizp_2025092123210424390149841", "학부모 과외 리뷰 v2", Profile.YEDU_OFFICIAL),
