...
public class BizppurioTeacherMessage {
    ...
    public void photoSubmit(PhotoSubmitEvent photoSubmitEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToApplyPhotoSubmit(photoSubmitEvent));
    }

    public void photoHurry(PhotoHurryEvent photoHurryEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToPhotoHurry(photoHurryEvent));
    }

    public void applyAgree(ApplyAgreeEvent applyAgreeEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToApplyAgree(applyAgreeEvent));
    }

    public void matchingChannel(InviteMatchingChannelInfoEvent inviteMatchingChannelInfo) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToMatchingChannel(inviteMatchingChannelInfo));
    }

    public void notifyClass(NotifyClassInfoEvent notifyClassInfoEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToNotifyClass(notifyClassInfoEvent));
    }

    public void acceptCase(MatchingAcceptCaseInfoEvent matchingAcceptCaseInfoEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToMatchingAcceptCase(matchingAcceptCaseInfoEvent));
    }

    public void refuseCase(MatchingRefuseCaseEvent matchingRefuseCaseEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToRefuseCase(matchingRefuseCaseEvent));
    }

    public void refuseCaseNow(MatchingRefuseCaseNowEvent matchingRefuseCaseEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToRefuseCaseNow(matchingRefuseCaseEvent));
    }

    public void refuseCaseDistrict(MatchingRefuseCaseDistrictEvent matchingRefuseCaseEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToRefuseCaseDistrict(matchingRefuseCaseEvent));
    }

    public void teacherExchange(TeacherExchangeEvent teacherExchangeEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToTeacherExchangePhoneNumber(teacherExchangeEvent));
    }

    public void teacherClassRemind(TeacherClassRemindEvent teacherExchangeEvent) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToTeacherClassRemind(teacherExchangeEvent));
    }

    public void matchingConfirmTeacher(MatchingConfirmTeacherEvent event) {
        bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToClassGuide(event.classGuideEvent()));
        String refKey = bizppurioSend.sendMessageWithExceptionHandling(() -> bizppurioMapper.mapToIntroduceFinishTalk(event.introduceFinishTalkEvent()));
        try {
